...
c
      ...
      write(0,*) i,xx(i),xx(i-1),xmg(i),xmg(i-1)
   10 continue
      write(0,6) nfunct
      write(0,4) t,nn,mm
      write(0,5) xmag0
...
*     read(1,112) hypodata
  112 format(a)
      ...
      read(1,*) (xini(i),i=1,n)
      close(unit=1)
      write(0,*) ' cutoff-mag/  ref-mag/    t_0  /     T   / dead-time.'
      write(0,5) amx1,xmag0,zts,zte,tstart
    1 format(1h ,20a4)
    4 format(8f10.3)
    5 format(1h ,8f10.3)
    6 format(3i10)
...
c
      ...
      dep(nn)=dep(i)
   10 continue
      write(0,*) 'input hypocenter data'
      write(0,7) (i,xx(i),xmg(i),i=1,nn)
    7 format(3(i5,f12.5,f4.1))
      mm=nd
      write(0,*) 'read #data; selected #data; #tstart; M_0'
      write(0,8)  nd, nn, ntstar, amx1
...
c
   ...
   10 continue
c
c     write(0,1002) (i-ntstar,xmg(i),x(i),x(i)-x(i-1),i=1,nn)
      write(0,1002) (i-ntstar,xmg(i),x(i),x(i)-x(i-1),xx(i),i=1,nn)
...
cmod 1005 format(i5,2f12.5,f12.1,f12.5,f8.2,2x,f13.5)
 1005 format(i5,2f12.5,f12.1,f12.5,f8.2,2x,e13.5)
cxx      call flush(1)
      close(unit=1)
